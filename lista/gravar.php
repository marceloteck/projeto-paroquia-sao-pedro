...
/** COMANDOS POST E GET **/
	...
	if($linksLetra != ""){
		...
		//$contentArray = str_replace("<h1>","<h1>", $contentArray);
		
		$contentArray = '<br /> <div class="container">'.$contentArray.'</div>';
		
		//ADICIONANDO UMA DIV
		$contentArray = str_replace('<div class="folha-cnt">','<div class="container"><div class="folha-cnt">', $contentArray);
		...
		$ConteudoFin = $top.' <!-- -->'.$tpo.$contentArray.$rodape;
		...
		$editor1 = '<br /> <div class="container crs"><h1><a id="crs" href="../../../video.php?v='.$videoYoutube.'&url=post/letras/'.$urlF.'/'.$link.'">'.$titulo.'</a></h1><br /> <div class="folha-cnt">'.$editor1.'</div></div>';
