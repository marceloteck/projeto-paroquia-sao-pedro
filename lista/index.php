...
?>
 <div class="container top_tab">
	<?php 
	include"buscarpastas.php";
	
	?>
	<a href="gravar.php"> <button type="button" class="btn btn-dark mais_missa">+</button></a>
	<br /><br />
	<a href="deletar.php"> <button type="button" class="btn btn-dark mais_missa">Apagar</button></a>
	<br />
